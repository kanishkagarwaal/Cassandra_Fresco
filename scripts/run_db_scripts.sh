...
COPY fresco_seg.customer_seg (party_id,fresco13_mseg,fresco13_seg,fresco13_sseg,match_flag) FROM '/Cassandra_scripts/data/DatasetGenerated.csv' WITH DELIMITER=',' AND HEADER = TRUE ;
